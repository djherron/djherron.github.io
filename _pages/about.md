...
I am currently doing post-doctoral research in artificial intelligence for Dr. Ernesto Jimenez-Ruiz at City St George's, University of London.  The research project, funded by the UK's [Alan Turing Institute](https://www.turing.ac.uk/), currently focuses on **OWL ontology alignment**. We are exploring ways of improving the quality of the ontology alignments generated by the [LogMap](https://github.com/ernestojimenezruiz/logmap-matcher) **ontology matching system** by integrating the use of **LLMs (large language models)** as oracles to help predict whether candidate ontology entity mappings are true (correct) or false (incorrect).

---

## My PhD research

My PhD research focused on **neurosymbolic learning and reasoning with OWL-based knowledge graphs**.  
